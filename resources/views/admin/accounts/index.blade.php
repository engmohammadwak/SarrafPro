...
<div class="card">
    ...
    <div class="card-body" style="padding:0">
        ...
        <table>
            <thead><tr><th>#</th><th>اسم الحساب</th><th>النوع</th><th>العملة</th><th>الرصيد</th><th>إجراءات</th></tr></thead>
            <tbody>
            ...
            <tr>
                ...
                <td>
                    @if($a->type==='cash')<span class="badge badge-success">نقدي</span>
                    @elseif($a->type==='bank')<span class="badge badge-info">بنك</span>
                    @else<span class="badge badge-warning">خزنة</span>@endif
                </td>
                <td>{{ $a->currency }}</td>
            ...
            @empty
            <tr><td colspan="6" style="text-align:center;padding:40px;color:var(--text-muted)">لا يوجد حسابات</td></tr>
            @endforelse
            </tbody>
        </table>
        </div>
