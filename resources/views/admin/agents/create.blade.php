...
.link-type-card-body {
    ...
    gap: 8px; padding: 16px 12px 14px; border-radius: 12px;
...
.link-type-card-label { font-size: 13px; font-weight: 600; color: var(--text-primary,#1a1a2e); line-height: 1.3; transition: color 0.18s; }
...
@media(max-width:640px){ .link-type-selector{grid-template-columns:1fr} }
</style>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px">
                ...
                <div>
                    ...
                    <div style="position:relative">
                        ...
                        <input type="text" id="country_search" placeholder="ابحث عن دولة..." autocomplete="off"
                               class="form-control" style="padding-right:34px">
                        <input type="hidden" name="country" id="country_value" value="{{ old('country') }}">
                        <div id="country_dropdown"
                             style="display:none;position:absolute;top:100%;right:0;left:0;background:#fff;border:1px solid rgba(0,0,0,0.1);border-radius:8px;max-height:200px;overflow-y:auto;z-index:999;box-shadow:0 4px 15px rgba(0,0,0,0.1)"></div>
                    </div>
                </div>
            </div>

            {{-- صف 3: الشركة (full width) --}}
